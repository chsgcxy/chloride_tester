...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
    ...
    {TEXT_CreateIndirect, "硝酸银浓度", ID_TEXT_XSYND, 440, 100, 195, 25, 0, 0x64, 0},
    {TEXT_CreateIndirect, "Text", ID_TEXT_XSYND_VALUE, 640, 100, 150, 25, 0, 0x64, 0},

    {TEXT_CreateIndirect, "空白实验用量", ID_TEXT_KBSYXXYYL, 440, 130, 250, 25, 0, 0x64, 0},
    {TEXT_CreateIndirect, "Text", ID_TEXT_KBSYXXYYL_VALUE, 640, 130, 80, 25, 0, 0x64, 0},

    {TEXT_CreateIndirect, "硝酸银用量", ID_TEXT_XSYYL, 440, 160, 250, 25, 0, 0x64, 0},
