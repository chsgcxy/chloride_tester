...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
    ...
    {TEXT_CreateIndirect, "ÈÜÒº´æÁ¿", ID_TEXT_RYCL, 5, 435, 120, 35, 0, 0x64, 0},
    {PROGBAR_CreateIndirect, "Progbar", ID_PROGBAR_0, 135, 435, 150, 30, 0, 0x0, 0},
    {BUTTON_CreateIndirect, "ÎüÒº", ID_BUTTON_GET, 320, 425, 120, 50, 0, 0x0, 0},
    {BUTTON_CreateIndirect, "ÅÅÒº", ID_BUTTON_PUT, 490, 425, 120, 50, 0, 0x0, 0},
    {BUTTON_CreateIndirect, "ÇåÏ´", ID_BUTTON_CLEAR, 660, 425, 120, 50, 0, 0x0, 0},
    
    {TEXT_CreateIndirect, "ÂÈÀë×Ó±ê×¼ÒºÅ¨¶È", ID_TEXT_NACLND, 5, 5, 250, 32, 0, 0x64, 0},
    {TEXT_CreateIndirect, "0.02mol/L", ID_TEXT_NACLND_VALUE, 75, 40, 160, 32, 0, 0x64, 0},

    {TEXT_CreateIndirect, "AgNO3Å¨¶È", ID_TEXT_NO3ND, 5, 75, 160, 32, 0, 0x64, 0},
    {TEXT_CreateIndirect, "---- mol/L", ID_TEXT_NO3ND_VALUE, 75, 110, 160, 32, 0, 0x64, 0},
    
    {TEXT_CreateIndirect, "AgNO3ÓÃÁ¿", ID_TEXT_NO3YL, 5, 145, 160, 32, 0, 0x64, 0},
    {TEXT_CreateIndirect, "0mL", ID_TEXT_NO3YL_VALUE, 75, 180, 160, 32, 0, 0x64, 0},

    {TEXT_CreateIndirect, "Ë®ÄàÂÈÀë×ÓÖÊÁ¿·ÖÊý", ID_TEXT_PERCENTAGE, 5, 215, 250, 32, 0, 0x64, 0},
    {TEXT_CreateIndirect, "----%", ID_TEXT_PERCENT_VALUE, 75, 250, 160, 32, 0, 0x64, 0},

    {TEXT_CreateIndirect, "ÎÂ¶È", ID_TEXT_TEMP, 5, 300, 160, 32, 0, 0x64, 0},
    {TEXT_CreateIndirect, "37.5", ID_TEXT_TEMP_VALUE, 75, 303, 160, 32, 0, 0x64, 0},

    {BUTTON_CreateIndirect, "·µ»Ø²Ëµ¥", ID_BUTTON_RETURN, 600, 5, 180, 60, 0, 0x0, 0},
    {BUTTON_CreateIndirect, "AgNO3¼ì²â", ID_BUTTON_START_NO3, 600, 110, 180, 60, 0, 0x0, 0},
    {BUTTON_CreateIndirect, "¿Õ°×ÊµÑé", ID_BUTTON_START_BLOCK, 600, 215, 180, 60, 0, 0x0, 0},
    {BUTTON_CreateIndirect, "ÂÈÀë×Ó¼ì²â", ID_BUTTON_START_TEST, 600, 320, 180, 60, 0, 0x0, 0},
