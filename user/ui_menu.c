...
#define TEXT_LINE1_YPOS     (BMP_LINE1_YPOS + 72)
#define BMP_LINE2_YPOS      (TEXT_LINE1_YPOS + 100)
#define TEXT_LINE2_YPOS     (BMP_LINE2_YPOS + 72)
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
    ...
    { IMAGE_CreateIndirect, "block", ID_IMAGE_BLOCKTEST, 102, BMP_LINE1_YPOS, 72, 72, 0, 0, 0 },
    { IMAGE_CreateIndirect, "stand", ID_IMAGE_STAND, 274, BMP_LINE1_YPOS, 72, 72, 0, 0, 0 },
    ...
    { TEXT_CreateIndirect, "extest", ID_TEXT_EXTEST, 247, TEXT_LINE2_YPOS, 140, 45, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
    ...
    case WM_INIT_DIALOG:
        ...
        hItem = WM_GetDialogItem(pMsg->hWin, ID_IMAGE_DROPPER);
        IMAGE_SetBitmap(hItem, &bmdropper_72px);
    ...
    case WM_NOTIFY_PARENT:
        ...
        case ID_TEXT_SETTING:
            ...
            break;
        case ID_IMAGE_DROPPER:
        case ID_TEXT_DROPPER:
            switch(NCode) {
            case WM_NOTIFICATION_CLICKED:
                beep_clicked();
